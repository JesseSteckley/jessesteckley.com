...
import { a as getBaseURL, i as PACKAGE_VERSION, n as GROK_PROVIDERS, r as GENERIC_OAUTH_ERROR_CODES } from "./router-DpKlrIRJ.mjs";
import { a as atom, i as onSet, n as STORE_UNMOUNT_DELAY, r as onMount, t as listenKeys } from "../_libs/nanostores.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-DtKZfPBS.js
...
function Login() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
		className: "min-h-screen grid place-items-center bg-bg px-6 text-fg",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "w-full max-w-sm space-y-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs uppercase tracking-[0.18em] text-accent mb-3",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: GROK_PROVIDERS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: "w-full min-h-11 rounded-md border border-border px-4 py-2.5 text-sm font-medium text-fg hover:bg-elevated transition-colors duration-150",
