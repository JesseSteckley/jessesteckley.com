...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "Jesse Steckley, Economic Reconciliation Advisor" },
      ...
      { name: "twitter:image:alt", content: "Jesse Steckley, Economic Reconciliation Advisor" },
