export const SITE = {
  ...
  github: "https://github.com/JesseSteckley",
  githubUser: "JesseSteckley",
  ...
  keywords: [
    ...
    "Indigenous economic strategist",
...
export const FAQ = [
  ...
  {
    q: "How do we start?",
    a: "Book a 30-minute Google Meet discovery call from this site. Bring the file as it is. If you are not ready to pick a time, email jessesteckley@gmail.com.",
  },
  {
    q: "What is Waaseyak?",
